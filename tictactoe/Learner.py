...
import numpy as np
from tictactoe.Experience import Experience
...
class Learner:
    ...
    def vCap(self, boardstate):
                game=Game()
                feature[0] = 1
                feature[1], feature[2] = game.feature12(boardstate)  # Feature 1 is 'x' in the same row as two 'o' & Feature 2 the viceversa
